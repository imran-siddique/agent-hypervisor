"""
Per-Agent Per-Ring Rate Limiter — token bucket rate limiting.

Prevents a misbehaving or compromised agent from exhausting shared
session resources by flooding the hypervisor with requests.
"""
