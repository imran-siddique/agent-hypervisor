...
## About Agent Hypervisor

**Agent Hypervisor** is part of the [Agent Governance Ecosystem](https://github.com/imran-siddique) — a suite of open-source projects for building, orchestrating, and governing autonomous AI agents in enterprise environments.
...
Only the latest release of Agent Hypervisor receives security updates. Users are strongly encouraged to stay up to date.

## Reporting a Vulnerability

If you discover a security vulnerability in Agent Hypervisor, please report it responsibly.
...
- Source code of Agent Hypervisor
- Third-party dependencies used by Agent Hypervisor
...
Agent Hypervisor is part of the broader **Agent Governance Ecosystem**, which provides a unified framework for secure, observable, and compliant AI agent operations. Security policies are coordinated across all ecosystem projects to ensure consistent protection.

For ecosystem-wide security concerns, please contact [security@imransiddique.com](mailto:security@imransiddique.com).

---

Thank you for helping keep Agent Hypervisor and the Agent Governance Ecosystem safe for everyone.
